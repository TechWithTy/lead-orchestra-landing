import { type CSS, type ScaleValue, createStitches } from '@stitches/react';

import { createKeyframes } from './keyframes';

export const { styled, css, globalCss, getCssText, keyframes, theme, config } = createStitches({
	theme: {
		colors: {
			...
			'accent-secondary': '#FD6584',
			'border-primary': 'rgba(36, 36, 36, 0.547)',
			'shadow-primary': '#00000047',

			'text-gradient': '-webkit-linear-gradient(0deg, $accent-primary 0%, $accent-secondary 100%)',
		},
