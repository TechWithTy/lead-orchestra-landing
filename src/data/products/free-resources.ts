import { ProductCategory, type ProductResource, type ProductType } from '@/types/products';
import {
...
export const freeResourceProducts: ProductType[] = [
	...
	},
	{
		...
		categories: [ProductCategory.FreeResources, ProductCategory.Data, ProductCategory.Automation],
		images: ['/products/workflows.png'],
		types: defaultTypes,
		reviews: [],
		colors: defaultColors,
