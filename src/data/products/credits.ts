import { LicenseType, ProductCategory, type ProductType, type Review } from '@/types/products';
import type { ABTestCopy } from '@/types/testing';
import { AIConversationCreditsABTest, abTestExample, skipTraceCreditsABTests } from './copy';
...
export const creditProducts: ProductType[] = [
	{
		...
		categories: [ProductCategory.Credits, ProductCategory.AddOn, ProductCategory.Automation],
	...
	},
	{
		...
		categories: [ProductCategory.Credits, ProductCategory.AddOn, ProductCategory.Leads],
		images: ['/products/coins.png'],
		types: [
