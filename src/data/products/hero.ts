...
export const DEFAULT_GRID: HeroGridItem[] = [
	...
	},
	{
		...
		label: 'Lead Credits',
		categoryId: 'credits',
		description: 'Power your scraping workflows and data processing operations with lead credits.',
	...
	},
	{
		...
		label: 'Lead Magnets',
		categoryId: 'free-resources',
		description: 'Free resources, templates, and guides to get started with Lead Orchestra.',
		link: '/products#category=free-resources',
		ariaLabel: 'Explore Lead Orchestra lead magnets',
		colSpan: 1,
		rowSpan: 1,
	...
	},
	{
		...
		description: 'Pre-configured scraping workflows for Zillow, LinkedIn, MLS, and more.',
	...
	},
	{
		...
		categoryId: 'workflows',
		description: 'CRM, Database, S3, and workflow engine integrations for exporting scraped data.',
