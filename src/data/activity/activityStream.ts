...
export const activityStream: ActivityEvent[] = [
	...
	},
	{
		...
		label: 'Data Export',
		actor: 'Export Engine',
		action: 'Exported normalized lead data to Deal Scale for AI enrichment and scoring.',
		timeAgo: '5m ago',
	...
	},
	{
		...
		action: 'Normalized 1,200 scraped records, deduplicated, and tagged with metadata.',
		timeAgo: '18m ago',
	...
	},
	{
		...
		action: 'Published weekly scraping performance report: 5,000+ leads scraped across 8 sources.',
		timeAgo: '1h ago',
		impact: '+5,000 leads',
