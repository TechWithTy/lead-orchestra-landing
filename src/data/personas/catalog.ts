...
const deriveGoal = (persona: PersonaKey): string => {
	...
	if (persona in HERO_COPY_V7.personas) {
		...
		return personaConfig.solution[0] ?? personaConfig.hope[0] ?? HERO_INVESTOR_GOAL;
	}
...
export const PERSONA_DISPLAY_ORDER: PersonaKey[] = ['developer', 'agency', 'startup', 'enterprise'];

export const ALL_PERSONA_KEYS = Object.keys(HERO_COPY_V7.personas) as PersonaKey[];
