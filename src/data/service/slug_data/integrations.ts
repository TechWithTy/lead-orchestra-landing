		...
		libraries: [
			{
				...
				description: 'Simple JavaScript snippet for easy embedding on any website.',
				lucideIcon: 'Code2',
	...
	},
	{
		...
		libraries: [
			...
			},
			{
				...
				description: 'Direct appointment booking into connected sales team calendars.',
			...
			},
			{
				...
				description: 'Real-time alerts to sales agents for hot leads or live transfer requests.',
				lucideIcon: 'Bell',
			},
		],
	},
		...
		libraries: [
			{
				...
				description: 'Track chatbot interactions and conversions within your website analytics.',
