		...
		content: (
			<div>
				<p className="mb-8 font-normal text-neutral-800 text-xs md:text-sm dark:text-neutral-200">
					The journey began with deep-dive interviews with developers, agencies, and data teams. We
					identified the pain points in manual data extraction and saw a gap for open-source,
					developer-friendly scraping tools with unified MCP architecture.
				</p>
		...
		content: (
			<div>
				<p className="mb-4 font-normal text-neutral-800 text-xs md:text-sm dark:text-neutral-200">
					Our MVP launched, focused on core scraping engine, MCP API aggregator, and data
					normalization. Early adopters saw a 70% reduction in manual data extraction time and
					access to fresh leads no one else had.
				</p>
				<div className="mb-8 space-y-2">
					...
					<div className="flex items-center gap-2 font-semibold text-neutral-800 text-xs md:text-sm dark:text-neutral-200">
						✅ 50+ custom scraping sources created using MCP plugin architecture.
					</div>
					<div className="flex items-center gap-2 text-neutral-700 text-xs md:text-sm dark:text-neutral-300">
						✅ Teams reported 3x faster lead acquisition with fresh, unique data.
					</div>
				</div>
				<div className="grid grid-cols-2 gap-4">
					<img
		...
		content: (
			<div>
				<p className="font-normal text-neutral-800 text-xs md:text-sm dark:text-neutral-200">
					With feedback from early users, we doubled down on developer tooling, SDKs, and plugin
					marketplace. The platform began enabling teams to scrape any source, normalize data
					automatically, and export to their existing infrastructure.
				</p>
				<p className="mt-4 font-normal text-neutral-800 text-xs md:text-sm dark:text-neutral-200">
					Our mission: to become the essential scraping engine for every developer, agency, and data
					team who wants fresh leads, not rented lists.
				</p>
			</div>
		),
	},
