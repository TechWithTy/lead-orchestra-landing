...
export const closerFormSchema = z.object({
	...
	realEstateLicense: z.string().min(1, { message: 'Real estate license number is required.' }),
	licenseState: z.string().min(2, { message: 'License state is required.' }),
	yearsExperience: z.string().min(1, { message: 'Please specify years of experience.' }),
	dealsClosed: z.string().min(1, { message: 'Please specify number of deals closed.' }),
