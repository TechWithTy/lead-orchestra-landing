...
export const vaFormSchema = z.object({
	...
	hourlyRateRange: z.string().min(1, { message: 'Please select your hourly rate range.' }),
	portfolioUrl: z
		.string()
	...
	whyApply: z.string().min(50, {
		message: 'Please provide at least 50 characters explaining why you want to apply.',
	}),
