...
export const NewsletterFooter = () => {
	...
	return (
		<div className="flex w-full flex-col items-center justify-center">
			<div className="flex w-full max-w-md flex-col gap-4 rounded-lg bg-slate-100/50 p-5 shadow-black/5 shadow-lg dark:bg-white/5 dark:shadow-black/40">
						...
						<div className="flex w-full flex-col gap-3">
							<div className="flex items-center gap-2">
								...
								<Input
									...
									{...register("email")}
									className="h-10 min-w-0 flex-1 rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary dark:border-gray-700 dark:text-gray-100"
