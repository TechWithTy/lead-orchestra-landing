...
describe("Attribution Tracking Logic", () => {
    ...
    describe("getAttributionFieldsFromUrl", () => {
        it("should capture parameters from URL and store them in localStorage", () => {
            ...
            const stored = JSON.parse(window.localStorage.getItem("lo_attrib") || "{}");
        ...
        it("should implement first-touch wins logic", () => {
            ...
            const storedAfterFirst = JSON.parse(window.localStorage.getItem("lo_attrib") || "{}");
            ...
            const storedAfterSecond = JSON.parse(window.localStorage.getItem("lo_attrib") || "{}");
        ...
        it("should merge new fields while keeping old ones (first-touch per field)", () => {
            ...
            getAttributionFieldsFromUrl("https://example.com/?utm_source=first_source");
            
            // Second touch has campaign but different source
            const result = getAttributionFieldsFromUrl("https://example.com/?utm_source=second_source&utm_campaign=first_campaign");
    ...
    describe("HiddenAttributionFields Component", () => {
        it("should render hidden inputs for all tracking keys", () => {
            ...
            const keys = [
                ...
                "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "utm_icp"
            ];
        ...
        it("should populate inputs from localStorage on mount", () => {
            ...
            const gclidInput = document.querySelector('input[name="gclid"]') as HTMLInputElement;
            const utmSourceInput = document.querySelector('input[name="utm_source"]') as HTMLInputElement;
